                    ...
                    <aside className="w-full lg:w-1/4 lg:pr-8">
                        <div className="p-6 bg-white rounded-lg shadow-sm sticky top-24">
                            ...
                            <FilterDisclosure title="Price">
                                <input type="range" min="100" max="3000" step="50" value={filters.price} onChange={(e) => setFilters(f => ({ ...f, price: Number(e.target.value) }))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer mt-4"/>
